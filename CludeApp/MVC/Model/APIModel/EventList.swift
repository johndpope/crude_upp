...
public final class EventList: NSCoding {
  ...
  private struct SerializationKeys {
    ...
    static let pdfSolution = "pdfSolution"
  }
  ...
  public required init(json: JSON) {
    ...
    pdfSolution = json[SerializationKeys.pdfSolution].string
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = pdfSolution{dictionary[SerializationKeys.pdfSolution] = value}
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.pdfSolution = aDecoder.decodeObject(forKey: SerializationKeys.pdfSolution) as? String
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(pdfSolution, forKey: SerializationKeys.pdfSolution)
