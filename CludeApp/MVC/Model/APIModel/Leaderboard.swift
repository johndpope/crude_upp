...
public final class Leaderboard: NSCoding {
  ...
  public var startedAtMili: Int?
  public var startedAt: Int?
  public var minutesDelay: Int?
  public var timestamp: Int?
  public var time: Int?
  public var endedAtMili: Int?
  ...
  public required init(json: JSON) {
    ...
    startedAtMili = json[SerializationKeys.startedAtMili].int
    startedAt = json[SerializationKeys.startedAt].int
    ...
    endedAtMili = json[SerializationKeys.endedAtMili].int
    endedAt = json[SerializationKeys.endedAt].int
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.startedAtMili = aDecoder.decodeObject(forKey: SerializationKeys.startedAtMili) as? Int
    self.startedAt = aDecoder.decodeObject(forKey: SerializationKeys.startedAt) as? Int
    ...
    self.endedAtMili = aDecoder.decodeObject(forKey: SerializationKeys.endedAtMili) as? Int
    self.endedAt = aDecoder.decodeObject(forKey: SerializationKeys.endedAt) as? Int
  }
